...
//   fill_rainbow(hue++); //fill all leds with rainbow, and then iterate through the hue values moving the raindown gradient.
...
void SingleLedMove()
{
  ...
  leds[current] = ColorFromPalette(RainbowColors_p, cIndex, 255, LINEARBLEND);
